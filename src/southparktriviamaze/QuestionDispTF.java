 ...
 * is returned.
 * 
 *  * display layout and window code generated by eclipse window builder and edited by Olin L. Anderson
 */
...
btnTrue.addKeyListener(new KeyAdapter()
{
	 ...
	 * listens for the up and down arrows to be pressed and changes the focus to the appropriate button
	 * parameters:
	 * KeyEvent e what key was pressed
	 * Returns:
	 * void
	 * throws:
	 * none
...
btnFalse.addKeyListener(new KeyAdapter() 
{
	...
	public void keyPressed(KeyEvent e)
	{
		...
		btnFalse.addActionListener(new ActionListener() 
		{
			 ...
			 * if false button is pressed the final answer is set to false and the dialog visibility is set to false
			 * Parameters:
			 * ActionEvent e the false button is pressed
			 * returns:
			 * void
			 * throws:
			 * none
